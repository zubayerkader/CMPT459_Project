...
def main():
    ...
    # print("KNeighborsClassifier Test score: {0:.2f} %".format(100 * score))
    #
    #
    ...
    # Ytest = sample['outcome']
    # score = pickle_model.score(Xtest, Ytest)
    # print("RandomForestClassifier Test score: {0:.2f} %".format(100 * score))
    ...
    Ytest = sample['outcome']
    score = pickle_model.score(Xtest, Ytest)
    print("AdaBoostClassifier Test score: {0:.2f} %".format(100 * score))
